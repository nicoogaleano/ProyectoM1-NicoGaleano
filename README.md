...
- **HTML5:** Estructuración semántica del esqueleto de la aplicación.
- **CSS:** Estilos avanzados, animaciones, uso de variables nativas (`:root`), filtros de opacidad (`rgba`) y efectos de resplandor mediante sombras dinámicas (`text-shadow` y `box-shadow`).
- **JavaScript (JS):** Lógica del negocio, algoritmos de generación de códigos hexadecimales aleatorios, manipulación interactiva del DOM y uso de la API del portapapeles (`navigator.clipboard`).
